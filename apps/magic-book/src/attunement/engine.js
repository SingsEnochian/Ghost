...
export function createAttunementEngine({root, patterns = [], getContext = () => ({}), onResolved = () => {}, options = {}}) {
    if (!root?.addEventListener) {
        return {destroy() {}, clear() {}, ingest() {}, flush() { return null; }, getSequence: () => []};
    }
    ...
    return {
        ...
        clear() { sequence = []; clearTimeout(timer); timer = null; },
        ingest,
        flush,
